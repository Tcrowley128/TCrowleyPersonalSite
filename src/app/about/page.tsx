        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Product & Project Management</h3>
          ...
          >
            <div className="bg-white rounded-xl shadow-sm p-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Bachelor of Business Administration</h3>
                  <p className="text-blue-600 font-medium">College of Charleston</p>
                  <p className="text-gray-500">2012</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-semibold text-gray-900">Bosch Talent Pool 2</h3>
                  <p className="text-gray-600 text-sm">Active Member | 2024</p>
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-gray-900">AI Product Management</h3>
                  <p className="text-gray-600 text-sm">Maven | 2025</p>
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-gray-900">Certified Scrum Product Owner</h3>
                  <p className="text-gray-600 text-sm">Scrum Alliance | 2015, 2023</p>
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-gray-900">Change Practitioner Certified</h3>
                  <p className="text-gray-600 text-sm">Prosci | 2022</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white rounded-xl shadow-sm p-8 md:p-12 mb-16"
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Technical Proficiencies</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Automation & Design</h3>
                <div className="flex flex-wrap gap-2">
