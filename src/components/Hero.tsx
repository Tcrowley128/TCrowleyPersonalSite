              ...
              >
                <div className="text-center max-w-2xl">
                  <p className="text-base font-semibold text-gray-800 dark:text-gray-200 mb-2">
                    Access Premium Digital Tools
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Register to unlock our Digital Transformation Assessment and Journey Management Platform -
                    powerful tools designed to accelerate your organization's digital initiatives
                  </p>
                </div>
