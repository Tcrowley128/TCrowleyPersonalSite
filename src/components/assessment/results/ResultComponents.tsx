...
export function OverviewTab({ maturity, priority, quickWinsCount, onQuickEdit }: any) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-100 dark:bg-slate-800 border border-gray-200 dark:border-gray-600 rounded-xl p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {safeOperationalAreas.map((areaValue: string, index: number) => {
          ...
          return (
            <div
              key={index}
              className="bg-gray-100 dark:bg-slate-800 border-2 border-gray-200 dark:border-gray-600 rounded-xl p-6"
            >
