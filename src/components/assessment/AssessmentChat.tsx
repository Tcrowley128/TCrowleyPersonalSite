                        ...
                        <>
                          ...
                          {isLoading && messages[messages.length - 1]?.role === 'user' && (
                            <div className="flex justify-start">
                              <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl px-5 py-4 shadow-sm">
                                <div className="flex items-center gap-3">
                                  <div className="relative">
                                    <Loader2 className="w-5 h-5 animate-spin text-blue-600 dark:text-blue-400" />
                                    <Sparkles className="w-3 h-3 text-purple-600 dark:text-purple-400 absolute -top-1 -right-1 animate-pulse" />
                                  </div>
                                  <div>
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-700 p-4 flex-shrink-0">
                      ...
                      <div className="flex gap-2">
                        <textarea
                          ...
                          placeholder={isLoading ? "Please wait..." : "Ask about your assessment..."}
                          disabled={isLoading}
                          className="flex-1 resize-none bg-gray-100 dark:bg-slate-700 border-0 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-blue-600 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
                          rows={2}
                        />
                        <button
                          onClick={sendMessage}
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                        {isLoading ? "Please wait for the current response to complete" : "Press Enter to send, Shift+Enter for new line"}
                      </p>
                    </div>
                  </div>
                </div>
